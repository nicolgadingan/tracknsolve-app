<form wire:submit.prevent="updateUser">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-6">
            <div class="col-md">
                <div class="form-floating">
                    <select name="role" id="us-edit-role" class="form-control" wire:model="role">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" name="username" id="us-edit-username"
                    maxlength="20" placeholder="Username" value="{{ $username }}" readonly>
        ...
        <div class="col-md">
            <div class="form-floating">
                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="us-edit-email"
                    maxlength="50" placeholder="Email" value="{{ $email }}" readonly>
                @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="col-md">
            <div class="form-floating">
                <input type="text" class="form-control" name="contact_no" id="us-edit-contact-no" maxlength="20" placeholder="Contact No"
                    value="{{ $contact_no }}" wire:model="contact_no">
